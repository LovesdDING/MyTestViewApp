...
public class ColorRingsView extends ViewGroup {
    ...
    public ColorRingsView(Context context) {
        this(context,null) ;
    }

    public ColorRingsView(Context context, AttributeSet attrs) {
        this(context,attrs,0) ;
    }


    public ColorRingsView(Context context, AttributeSet attrs, int defStyleAttr) {
