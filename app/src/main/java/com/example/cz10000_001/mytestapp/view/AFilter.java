...
import com.example.cz10000_001.mytestapp.glshape.ShaderUtils;
...
public abstract class AFilter implements GLSurfaceView.Renderer{
    ...
    @Override
    public void onSurfaceChanged(GL10 gl, int width, int height) {   //计算变换矩阵
    ...
    @Override
    public void onDrawFrame(GL10 gl) { //显示图片
