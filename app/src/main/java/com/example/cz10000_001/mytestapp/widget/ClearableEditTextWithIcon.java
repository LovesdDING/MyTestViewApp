...
/**
 * Created by cz10000_001 on 2017/11/30.
 */
 ...
 *
    ...
    public class ClearableEditTextWithIcon extends EditText implements View.OnTouchListener, TextWatcher {
        ...
        // 删除符号
        Drawable deleteImage = getResources().getDrawable(R.drawable.xxclearall);
        ...
        private void init() {
            ...
            deleteImage.setBounds(0, 0, 50, 50);  //deleteImage.getIntrinsicWidth()   deleteImage.getIntrinsicHeight()
