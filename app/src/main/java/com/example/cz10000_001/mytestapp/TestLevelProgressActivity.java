...
import com.example.cz10000_001.mytestapp.view.LevelProgressBar;

public class TestLevelProgressActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_level_progress);
