...
import static com.example.cz10000_001.mytestapp.view.AliPayView.State.FINISH;
import static com.example.cz10000_001.mytestapp.view.AliPayView.State.IDLE;

/**
 * 自定义View  实现支付宝 支付完成页面  ✔️
 * 
